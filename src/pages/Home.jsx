    ...
    <div className="relative min-h-screen bg-light-background dark:bg-background overflow-hidden">
      <div className="flex flex-col">
        <div className="absolute inset-0 pointer-events-none z-0">
          <div
            className={`absolute ${lang === "en" ? "-right-20 md:-right-50" : "-left-20 md:-left-50"} -top-10 w-64 h-64 md:w-180 md:h-180 bg-mid-pink/50 rounded-full blur-3xl opacity-20 pointer-events-none -z-10`}
          />
